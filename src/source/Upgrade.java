    ...
    public void paint(Graphics g, int x, int y, Mesa m) {
        if (m.getTipo() == 1 || m.getTipo() == 4 || m.getTipo() == 6) {
            ...
            if (funcion == 1) {
                ...
                if (pintar) {
                    g.drawString("Stronger", x + 10, y + 5);
                    contPintar++;
                    if (contPintar > 25) {
                        pintar = false;
                    }
                ...
                if (pintar) {
                    g.drawString("Hello Friend", x - 90, y - 5);
                    contPintar++;
                    if (contPintar > 25) {
                        pintar = false;
                    }
            ...
            g.setColor(Color.WHITE);
            if (funcion == 1) {
                g.drawImage(anim.getImagen(), x + 18, y - 5, null);
                if (pintar) {
                    g.drawString("Faster", x + 10, y + 5);
                    contPintar++;
                    if (contPintar > 25) {
                ...
                g.drawImage(anim.getImagen(), x + 10, y - 30, null);
                if (pintar) {
                    g.drawString("Stronger", x + 10, y + 5);
                    contPintar++;
                    if (contPintar > 25) {
                ...
                g.drawImage(anim.getImagen(), x + 25, y, null);
                if (pintar) {
                    g.drawString("Hello friend", x - 90, y - 10);
                    contPintar++;
                    if (contPintar > 25) {
                        pintar = false;
                    }
